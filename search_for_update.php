...
<div class="Main_Info">
  ...
  <p>Choose Order:</p>
  <p>(If this dropdown menu is empty that means either not working or no orders made)<p>
  <select name="Booking_ID">
	...
	while($stmt->fetch()) {
		...
		echo "<option value = ",$Booking_ID,">","Booking ID : ",$Booking_ID," Date of Order :  ",$Date," Price : £",$Total_Price,"</option>";
		echo "</br>";
	}
	$stmt->close();
	$db->close();
