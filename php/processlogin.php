...
if(isset($_POST['username']) && isset($_POST['userpass'])){ 
	...
	$loginsql="select userid, userpass, salt, firstname, surname, usertype from WebAppLogin where username=?";
	...
	if($lgnstmt->num_rows==1) {
		...
		if($cyphertext==$hash) {
			...
			$sessionsql="update WebAppLogin set sessionid=? where userid=?";
