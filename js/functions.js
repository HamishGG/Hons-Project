...
//creates a XHR request for the page
function createXHR() 
{
...
function setCookie(name,value,days) {
	...
	document.cookie = name+"="+escape(value)+((days==null) ? "" : expires+"; path=/~14016471");
}
...
//prepares the small menu that is used when in small screen devices
...
function prepareOrderMenu() {
	...
	var menutoggle=document.getElementById("OrderButton");
